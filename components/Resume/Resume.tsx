...
const Resume = () => {
  const WorkHistory = useMemo(() => {
    return [
      {
        id: nanoid(),
        companyName: "VinzGlobal",
        from: "May 2022",
        to: "Current",
        designation: "Senior Software Engineer",
        tasksHandled: [
          "Working comprehensively on frontend with React",
          "Electron.JS with react for a desktop application",
          "Working with team and planning sprint and CI/CD with Azure Devops",
        ],
      },
      {
        id: nanoid(),
